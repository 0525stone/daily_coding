...
data['tra']['dow'] = data['tra']['visit_date'].dt.dayofweek # 요일을 숫자로 보여줌. 월-0 화-1
data['tra']['year'] = data['tra']['visit_date'].dt.year
data['tra']['month'] = data['tra']['visit_date'].dt.month
data['tra']['visit_date'] = data['tra']['visit_date'].dt.date # YYYY-MM-DD(문)
